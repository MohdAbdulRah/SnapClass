...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter Your Name",placeholder="Eg. Ananya Roy")
            st.subheader("(Optional) Voice Enrollment")
            st.info("Enroll your for you voice only attendance")

            audio_data = None
            try:
                audio_data = st.audio_input("Record a short phrase like I am Present,My Name is Your_Name")
            except Exception as e:
                st.error(f"Voice Enrollement Error {e}")
                    ...
                    with st.spinner('Creating Profile'):
                        ...
                        if encodings:
                           ...
                           if response_data:
                            ...
                            st.error("COuldnt Capture Your Facial Recognigitons for Registration")
